                    ...
                    function exportJsonAlignment() {
                        ...
                        for (i = 0; i < allJSONexportObj.propertyAttribute.length; i++) {
                            if (allJSONexportObj.propertyAttribute[i].label) {
                                console.log(allJSONexportObj.propertyAttribute[i].label)
                                        ...
                                        for (j = 0; j < property.domain().annotations()[i].length; j++) {
                                            for (j = 0; j < property.domain().annotations()[i].length; j++) {
                                                if (property.domain().annotations()[i][j].value.search("http://") === -1) {
                                                    console.log(property.domain().annotations()[i][j].value.search("http://"))
                    ...
                    sidebar.updateGeneralOntologyInfo = function() {
                        ...
                        if (generalMetaObj.hasOwnProperty("title")) {
                            ...
                            if (typeof generalMetaObj.title === "object") {
                                d3.select("#newTitle").attr("value", languageTools.textInLanguage(generalMetaObj.title, preferredLanguage));
