                    ...
                    function exportRDFAlignment() {
                        ...
                        for (i = 0; i < propertyAttributeObjects.length; i++) {
                            for (j = 0; j < classAttributeObjects.length; j++) {
                                console.log(propertyAttributeObjects[i].range)
            ...
            (function(d3) {
                ...
                module.exports = function(graph) {
                    ...
                    filterMenu.setup = function(datatypeFilter, objectPropertyFilter, subclassFilter, disjointFilter, setOperatorFilter, nodeDegreeFilter, mappingFilter) {
                        ...
                        addFilterItem(mappingFilter, "mapping", "Mapping", "#mappingFilteringOption");
                        ...
                        filterCheckbox.on("click", function(silent) {
                            ...
                            if (silent !== true) {
                                if (graph.isMapMode() === true) {
                                    graph.subgraphGenerator(alignmentPane.getMapId(), alignmentPane.getNodeDegree())
                                }
                    ...
                    function handleClick(elementId) {
                        ...
                        return function() {
                            ...
                            if (correspondingStr.includes("=")) {
                                graph.mapMode(true);
                                graph.subgraphGenerator(correspondingIds[0], 2)
                                ...
                                d3.select("#degreeOption2").classed("selected", true);
            ...
            (function(d3) {
                ...
                module.exports = function(graph) {
                    ...
                    function displayPropertyInformation(property) {
                        ...
                        setIri(d3.select("#propiri"), property.iri());
                        ...
                        if (property.labelForCurrentLanguage() == "mapping") {
                            ...
                            setIriLabel(d3.select("#source"), property.range().labelForCurrentLanguage(), property.range().iri());
                            setIriLabel(d3.select("#target"), property.domain().labelForCurrentLanguage(), property.domain().iri());
                    ...
                    function displayNodeInformation(node) {
                        ...
                        setIri(d3.select("#iriNode"), node.iri());
                ...
                module.exports = function(graph) {
                    ...
                    alignmentPane.setup = function() {
                        ...
                        sortAsc.on("click", function() {
                            ...
                            console.log(orderAscMappings)
                            for (i in orderAscMappings) {
                                console.log(orderAscMappings[i].annotations())
                            }
                        ...
                        for (var i in mappings) {
                            if (mappings[i].annotations()) {
                                ...
                                mappingContainer.on("click", function() {
                                    var mapId = d3.select(this).attr("id");
                                    currentId = mapId;
                                    d3.select("#c_node").classed("hidden", false);
