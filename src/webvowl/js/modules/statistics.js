...
function storeTotalCounts(classesAndDatatypes, properties) {
  ...
  var seenProperties = __webpack_require__(62)(),
      i, l, property;
...
function storePropertyCount(properties) {
  for (var i = 0, l = properties.length; i < l; i++) {
      ...
      } else if (property.type() === "owl:ObjectProperty") {
...
function storeMappingCount(properties) {
  for (var i = 0, l = properties.length; i < l; i++) {
      var property = properties[i];
...
statistics.mappingsCount = function() {
