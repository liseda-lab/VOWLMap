...
function createInverseMarker(markerContainer, inverse) {
    ...
    if (inverse.labelForCurrentLanguage() === "mapping") {
        if (inverse.annotations().status[0].value == "unreviewed") {
            inverseMarker.append("path")
                //.attr("d", "M12,-8L0,0L12,8Z")
                .attr("d", "M0,0L " + -m1X + "," + -m1Y + "L" + -m2X + "," + -m2Y + "L" + 0 + "," + 0)
                .classed("unreviewed", true);
        } else if (inverse.annotations().status[0].value == "correct") {
            inverseMarker.append("path")
                //.attr("d", "M12,-8L0,0L12,8Z")
                .attr("d", "M0,0L " + -m1X + "," + -m1Y + "L" + -m2X + "," + -m2Y + "L" + 0 + "," + 0)
                .classed("correct", true);
        } else if (inverse.annotations().status[0].value == "incorrect") {
            inverseMarker.append("path")
                //.attr("d", "M12,-8L0,0L12,8Z")
                .attr("d", "M0,0L " + -m1X + "," + -m1Y + "L" + -m2X + "," + -m2Y + "L" + 0 + "," + 0)
                .classed("incorrect", true);
        } else if (inverse.annotations().status[0].value == "unsure") {
            inverseMarker.append("path")
                //.attr("d", "M12,-8L0,0L12,8Z")
                .attr("d", "M0,0L " + -m1X + "," + -m1Y + "L" + -m2X + "," + -m2Y + "L" + 0 + "," + 0)
                .classed("unsure", true);
