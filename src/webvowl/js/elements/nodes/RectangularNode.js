        ...
        if (that.annotations()) {
            ...
            if (that.annotations().status) {
                if (that.annotations().status[0].value === "unreviewed") {
                    that.nodeElement().select("rect").classed("unreviewed", true);
                } else if (that.annotations().status[0].value === "correct") {
                    that.nodeElement().select("rect").classed("correct", true);
                } else if (that.annotations().status[0].value === "incorrect") {
                    that.nodeElement().select("rect").classed("incorrect", true);
                } else if (that.annotations().status[0].value === "unsure") {
                    that.nodeElement().select("rect").classed("unsure", true);
                }
            }
        }
        graph.resetSearchHighlight();
