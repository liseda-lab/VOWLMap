...
var MappingProperty = require("../elements/properties/implementations/MappingProperty");
...
tools.isMapping = function (element) {
  return element instanceof MappingProperty;
};